<template>
    <v-dialog persistent v-model="isOpen" max-width="800px">
        <v-card>
            <v-card-title>
                <span v-if="topic.id" class="headline">Edit Topic</span>
                <span v-else class="headline">Add Topic</span>
            </v-card-title>
            <v-card-text>
                <v-container>
                    <v-row>
                        <v-col cols="12">
                            <v-text-field v-model="topic.title" label="Name*" required></v-text-field>
                        </v-col>
                    </v-row>
                    <v-row>
                        <v-col cols="12">
