        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title text-bold">
                    Topic Details (<small>{{course.title}} / {{module.title}} / {{topic.title}}</small>)
                </h3>
                <div class="card-tools">
                    <button @click="backToModule()" class="btn btn-dark btn-sm float-right">
        ...
        <div class="row mt-2">
            <div class="col-md-12">
                <ul class="nav nav-pills">
                    <li class="nav-item">
                        <a class="nav-link active" @click="disabledEditing()" href="#topic_description" data-toggle="tab">
                            Overview
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" @click="disabledEditing()" href="#topic_body" data-toggle="tab">
                            Content
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" :disabled="isOnLiveScreen" @click="disabledEditing('topic_live')" href="#topic_live" data-toggle="tab">
                            Live
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" @click="disabledEditing()" href="#topic_questions" data-toggle="tab">
                            Questions
                        </a>
                    </li>
                </ul>
